...
class PaginatedDetailedContractList implements \JsonSerializable
{
    /**
     * @var int|null
     */
     ...
     * @maps results
     *
     * @param EncryptedContract[]|null $results
     */
