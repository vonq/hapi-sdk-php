...
class CampaignModel implements \JsonSerializable
{
    ...
    /**
     * @var OrderedProductsGetElementModel[]|null
     */
    private $orderedProductsSpecs;

    /**
     * @var CampaignPostingModel[]|null
     */
    private $postings;
     ...
     *
     * @return OrderedProductsGetElementModel[]|null
     */
     ...
     *
     * @param OrderedProductsGetElementModel[]|null $orderedProductsSpecs
     */
     ...
     * Returns Postings.
     *
     * @return CampaignPostingModel[]|null
     */
     ...
     * @maps postings
     *
     * @param CampaignPostingModel[]|null $postings
     */
