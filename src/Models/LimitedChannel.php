...
class LimitedChannel implements \JsonSerializable
{
    /**
     * @var int
     */
     ...
     * @param ContractCredential[] $contractCredentials
     * @param Facet[] $contractFacets
