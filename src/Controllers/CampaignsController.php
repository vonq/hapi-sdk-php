...
class CampaignsController extends BaseController
{
     ...
     *
     * @return Models\PaginatedCampaignList Response from the API call
     *
    ...
    public function listCampaigns(
        ...
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'PaginatedCampaignList');
    }
     ...
     *
     * @return Models\CampaignData Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveCampaign(string $campaignId): Models\CampaignData
    {
        //prepare query string for API call
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'CampaignData');
    }
     ...
     *
     * @param string $campaignId ID of the campaign you want to retrieve or take action on
     * @param Models\TakeCampaignOfflineRequest $body
     *
     * @return Models\TakeCampaignOfflineResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function takeCampaignOffline(
        string $campaignId,
        Models\TakeCampaignOfflineRequest $body
    ): Models\TakeCampaignOfflineResponse {
        //prepare query string for API call
        ...
        if ($response->code == 400) {
            throw $this->createExceptionFromJson(
                '\\VONQHiringAPILib\\Exceptions\\TakeCampaignOfflineBadRequestErrorResponseException',
                '',
                $_httpRequest,
                $_httpResponse
            );
        ...
        if ($response->code == 404) {
            throw $this->createExceptionFromJson(
                '\\VONQHiringAPILib\\Exceptions\\TakeCampaignOfflineNotFoundErrorResponseException',
                '',
                $_httpRequest,
                $_httpResponse
            );
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'TakeCampaignOfflineResponse');
    }
     ...
     * @param string $campaignId ID of the campaign you want to retrieve or take action on
     *
     * @return Models\CampaignStatusResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function checkCampaignStatus(string $campaignId): Models\CampaignStatusResponse
    {
        //prepare query string for API call
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'CampaignStatusResponse');
    }
     ...
     * @param Models\CampaignCreateRequest $body
     *
     * @return Models\LimitedCampaign Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function orderCampaign(string $xCustomerId, Models\CampaignCreateRequest $body): Models\LimitedCampaign
    {
        //prepare query string for API call
        ...
        if ($response->code == 400) {
            throw $this->createExceptionFromJson(
                '\\VONQHiringAPILib\\Exceptions\\OrderCampaignErrorResponseException',
                '',
                $_httpRequest,
                $_httpResponse
            );
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'LimitedCampaign');
    }
     ...
     *        with Contracts functionality (adding contract, retrieving channels, ordering
     *        campaigns with contracts).
     * @param Models\CampaignValidationRequest|null $body
     *
     * @return Models\CampaignValidation Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postCampaignsValidateCampaign(
        string $xCustomerId,
        ?Models\CampaignValidationRequest $body = null
    ): Models\CampaignValidation {
        //prepare query string for API call
        ...
        if ($response->code == 422) {
            throw $this->createExceptionFromJson(
                '\\VONQHiringAPILib\\Exceptions\\CampaignValidationErrorException',
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'CampaignValidation');
    }
     ...
     *        with Contracts functionality (adding contract, retrieving channels, ordering
     *        campaigns with contracts).
     * @param Models\ProductValidationRequest|null $body
     *
     * @return Models\ProductValidation Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postCampaignsValidateChannelPosting(
        string $xCustomerId,
        ?Models\ProductValidationRequest $body = null
    ): Models\ProductValidation {
        //prepare query string for API call
        ...
        if ($response->code == 422) {
            throw $this->createExceptionFromJson(
                '\\VONQHiringAPILib\\Exceptions\\ProductValidationErrorException',
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'ProductValidation');
    }
     ...
     *        with Contracts functionality (adding contract, retrieving channels, ordering
     *        campaigns with contracts).
     * @param Models\VacancyValidationRequest|null $body
     *
     * @return Models\VacancyValidation Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postCampaignsValidateVacancyInfo(
        string $xCustomerId,
        ?Models\VacancyValidationRequest $body = null
    ): Models\VacancyValidation {
        //prepare query string for API call
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'VacancyValidation');
    }
}
