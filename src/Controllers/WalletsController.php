...
class WalletsController extends BaseController
{
     ...
     *
     * @return Models\Wallet Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getWallet(string $xCustomerId): Models\Wallet
    {
        ...
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'Wallet');
    }
     ...
     *        with Contracts functionality (adding contract, retrieving channels, ordering
     *        campaigns with contracts).
     * @param Models\WalletRequest|null $body
     *
     * @return Models\Wallet Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postWallet(string $xCustomerId, ?Models\WalletRequest $body = null): Models\Wallet
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri() . '/wallet';
        ...
        if ($response->code == 400) {
            throw $this->createExceptionFromJson(
                '\\VONQHiringAPILib\\Exceptions\\WalletValidationErrorException',
                'Bad Request',
                $_httpRequest,
                $_httpResponse
            );
     ...
     *        "Return to"
     *
     * @return Models\BillingPortalLink Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postWalletWalletIdBillingPortal(
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'BillingPortalLink');
    }

    /**
     * Initiates a payment intent object. To make a payment, one first needs to create a payment intent.
     *
     * @param Models\PaymentIntent|null $body
     *
     * @return Models\LimitedPaymentIntent Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postWalletPaymentIntent(?Models\PaymentIntent $body = null): Models\LimitedPaymentIntent
    {
        //prepare query string for API call
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'LimitedPaymentIntent');
    }
