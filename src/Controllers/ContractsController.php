...
class ContractsController extends BaseController
{
     ...
     *
     * @return Models\PaginatedContractList Response from the API call
     *
    ...
    public function listContracts(
        ...
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'PaginatedContractList');
    }
     ...
     *        with Contracts functionality (adding contract, retrieving channels, ordering
     *        campaigns with contracts).
     * @param Models\ContractCreateRequest $body
     *
     * @return Models\EncryptedContract Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function createContract(string $xCustomerId, Models\ContractCreateRequest $body): Models\EncryptedContract
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri() . '/contracts/';
        ...
        if ($response->code == 400) {
            throw $this->createExceptionFromJson(
                '\\VONQHiringAPILib\\Exceptions\\ContractCreateRequestValidationErrorException',
                'Bad Request',
                $_httpRequest,
                $_httpResponse
            );
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'EncryptedContract');
    }
     ...
     * @param int|null $offset The initial index from which to return the results
     *
     * @return Models\PaginatedDetailedContractList Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveMultipleContracts(
        ...
        ?int $limit = 50,
        ?int $offset = 0
    ): Models\PaginatedDetailedContractList {
        //prepare query string for API call
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'PaginatedDetailedContractList');
    }
     ...
     *        with Contracts functionality (adding contract, retrieving channels, ordering
     *        campaigns with contracts).
     * @param Models\FacetAutocomplete $body
     *
     * @return Models\AutocompleteValuesResponse[] Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function listAutocompleteValues(
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'AutocompleteValuesResponse', 1);
    }
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveContract(string $contractId, string $xCustomerId): Models\EncryptedContract
    {
        //prepare query string for API call
