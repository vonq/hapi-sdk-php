...
| `orderedProductsSpecs` | [`OrderedProductsGetElement[]`](../../doc/models/ordered-products-get-element.md) | Required | This part contains information of the ordered products. | getOrderedProductsSpecs(): array | setOrderedProductsSpecs(array orderedProductsSpecs): void |
| `postings` | [`CampaignPosting[]`](../../doc/models/campaign-posting.md) | Required | includes information about number of clicks per product | getPostings(): array | setPostings(array postings): void |
...
| `totalPrice` | [`PriceInCents`](../../doc/models/price-in-cents.md) | Required | - | getTotalPrice(): PriceInCents | setTotalPrice(PriceInCents totalPrice): void |
