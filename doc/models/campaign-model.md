...
| `orderedProductsSpecs` | [`?(OrderedProductsGetElementModel[])`](../../doc/models/ordered-products-get-element-model.md) | Optional | This part contains information of the ordered products. | getOrderedProductsSpecs(): ?array | setOrderedProductsSpecs(?array orderedProductsSpecs): void |
| `postings` | [`?(CampaignPostingModel[])`](../../doc/models/campaign-posting-model.md) | Optional | - | getPostings(): ?array | setPostings(?array postings): void |
