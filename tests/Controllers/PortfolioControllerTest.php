...
{
    /**
     * @var \HAPILib\Controllers\PortfolioController Controller instance
     */
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$controller = ClientFactory::create(self::$httpResponse)->getPortfolioController();
    }
...
Besides the default English, German and Dutch result translations can be requested by specifying an `Accept-Language: [de|nl]` header.
    ...
    public function testTestSearchProducts()
    {
        ...
        $result = null;
        try {
            $result = self::$controller->searchProducts($limit, $offset, $includeLocationId, $exactLocationId, $jobFunctionId, $jobTitleId, $industryId, $durationFrom, $durationTo, $name, $currency, $sortBy, $recommended, $mcEnabled, $acceptLanguage, $excludeRecommended);
