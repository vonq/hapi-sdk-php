...
class TaxonomyTrueTest extends TestCase
{
    /**
     * @var \HAPI\Trues\TaxonomyTrue Controller instance
     */
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$controller = ClientFactory::create(self::$httpResponse)->getTaxonomyTrue();
    }
