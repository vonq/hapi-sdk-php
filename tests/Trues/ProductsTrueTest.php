...
class ProductsTrueTest extends TestCase
{
    /**
     * @var \HAPI\Trues\ProductsTrue Controller instance
     */
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$controller = ClientFactory::create(self::$httpResponse)->getProductsTrue();
    }
